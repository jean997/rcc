...
```{r, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank, ci.naive, theta, prop = 0.2, plot.truth=TRUE) + ggtitle("Standard Marginal Intervals")
```
...
rcc:::plot_cis(rank[rank <= 100], ci.by, theta.sel, plot.truth=TRUE) + ggtitle("Benjamini and Yukatieli Intervals")
```
...
```
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank[rank <= 100], ci.wfb, theta.sel, plot.truth=TRUE) + ggtitle("Weinstein, Fithian, and Benjamini Intervals")
```
...
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank[rank <= 100], ci.rtt, theta.sel, plot.truth=TRUE) + ggtitle("Reid, Taylor, and Tibshirani Intervals")
```
...
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank, ci.boot, theta, prop=0.2, plot.truth=TRUE) + ggtitle("Parametric Bootstrap Intervals")
```
...
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank, ci.ash, theta, prop=0.2, plot.truth=TRUE) + ggtitle("ashr Credible Intervals (Stephens 2016)")
```
