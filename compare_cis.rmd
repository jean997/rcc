...
rcc:::plot_cis(rank, ci.naive, theta) + ggtitle("Standard Marginal Intervals")
```
...
rcc:::plot_cis(rank[rank <= 100], ci.by, theta.sel) + ggtitle("Benjamini and Yukatieli Intervals")
```
...
```
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank[rank <= 100], ci.wfb, theta.sel) + ggtitle("Weinstein, Fithian, and Benjamini Intervals")
```
...
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank[rank <= 100], ci.rtt, theta.sel) + ggtitle("Reid, Taylor, and Tibshirani Intervals")
```
...
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank, ci.boot, theta) + ggtitle("Parametric Bootstrap Intervals")
```
...
```{r, show=FALSE, hold=TRUE, echo=FALSE, out.width="0.5\\textwidth"}
rcc:::plot_cis(rank, ci.ash, theta) + ggtitle("ashr Credible Intervals (Stephens 2016)")
```
